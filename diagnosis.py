...
# Streamlit app
st.title("SHAP Analysis for Anemia Diagnosis")
...
for feature in X.columns:
    if feature in ['Gender', 'Hemoglobin', 'MCH', 'MCHC' 'MCV']:
...
# Display prediction
st.write(f"**Prediction:** {'Anemia' if prediction == 1 else 'No Anemia'}")
st.write(f"**Anemia Probability:** {probability:.2f}")
